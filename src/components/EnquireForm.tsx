...
const WHATSAPP_NUMBER = "917905793493";
...
export default function EnquireForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const msg = `Hi Local Travel Booking! 🙏
...
👥 Persons: ${form.persons || "Not specified"}
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            {status === "success" ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">WhatsApp opened with your details — we'll get back to you shortly!</p>
                <button
